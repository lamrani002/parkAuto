	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
					<h3 class="modal-title">Entrer une mission</h3>
	        <a class="close pull-right " href="{{url('mission')}}">&times;</a>
	      </div>
	      <div class="modal-body">
					<form action="{{url('mission')}}" method="post" enctype="multipart/form-data">
 			 		{{ csrf_field() }}
        <div class="row">
          <div class="col-md-12">
          ...
          <div class="col-md-6">
 			 		<div class="form-group @if($errors->get('date_arrive')) has-error @endif">
 			 			...
 			 			<input name="date_arrive" type="date" class="form-control" value="{{old('date_arrive')}}"/>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group @if($errors->get('vehicule_id')) has-error @endif">
              ...
              <select class="form-control" name="vehicule_id" value="{{old('vehicule_id')}}" style="height:34px">
          ...
          <div class="col-md-6">
	 			 		<div class="form-group @if($errors->get('user_id')) has-error @endif">
	 			 			...
	 			 			<select type="text" name="user_id" class="form-control" value="{{old('user_id')}}" style="height:34px">
